...
def _named_variations(name: Union[str, Tuple[str, int]]) -> \
    ...
    if name == 'erp':
        ...
        return settings
    elif name == 'fmri_raw_dds_direct_mixed_3':
        settings = Settings(
            corpora=(
                corpus_types.HarryPotterCorpus(
                    fmri_subjects=None,  # None means all
        ...
        settings.mixed_tasks = MixedTask.make_symmetric_mixed_tasks(['obj_num', 'tense'], 0.3)

        return settings
    elif name == 'fmri_raw_dds_direct_mixed_1':
        settings = Settings(
            corpora=(
                corpus_types.HarryPotterCorpus(
                    fmri_subjects=None,  # None means all
        ...
        settings.mixed_tasks = MixedTask.make_symmetric_mixed_tasks(['obj_num', 'tense'], 0.1)

        return settings
    elif name == 'fmri_raw_dds_direct_mixed_2':
        settings = Settings(
            corpora=(
                corpus_types.HarryPotterCorpus(
                    fmri_subjects=None,  # None means all
        ...
        settings.mixed_tasks = MixedTask.make_symmetric_mixed_tasks(['obj_num', 'tense'], 0.2)

        return settings
    elif name == 'fmri_raw_dds_direct_mixed_4':
        settings = Settings(
            corpora=(
                corpus_types.HarryPotterCorpus(
                    fmri_subjects=None,  # None means all
        ...
        settings.mixed_tasks = MixedTask.make_symmetric_mixed_tasks(['obj_num', 'tense'], 0.4)
